...
export default function Donation() {
    ...
    const EUR_donation_link = "https://donate.stripe.com/14kdTt9aQ0xn0Ra9AC"

    return (
        <div className="donnation_wrapper">
            <h3>Donnation</h3>
            <PrimaryButton text="Pix" width="100%" onClick={() => setShowModal(true)} />
            <PrimaryButton text="BRL Donation" width="100%" onClick={() => window.open(BRL_donation_link, "_blank")} />
            <PrimaryButton text="EUR Donation" width="100%" onClick={() => window.open(EUR_donation_link, "_blank")} />
            <PrimaryButton text="USD Donation" width="100%" onClick={() => window.open(USD_donation_link, "_blank")} />
            <Modal
                title="Pix Donation"
                show={showModal}
